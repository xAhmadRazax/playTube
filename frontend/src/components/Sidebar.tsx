...
// const expendedSidebarItems: Array<ExpendedSidebarItemsType> = [
//   {
//     logo: (
//       <svg
//         xmlns="http://www.w3.org/2000/svg"
...
//   return (
//     <aside className="hidden md:block  bg-zinc-800 h-full sticky top-0 pt-6">
//       <nav className="">
//         {isMenuOpen ? (
//           <ul
//             className={`flex flex-col  items-center ${isMenuOpen ? 'gap-2' : 'gap-6'} `}
//           >
//             {expendedSidebarItems.map((item: ExpendedSidebarItemsType) => (
//               <SidebarItem
