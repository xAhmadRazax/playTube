...
export const protect = asyncHandler(async (req, res, next) => {
    ...
    if (!accessToken) {
        ...
        throw new AppErrorV4(StatusCodes.UNAUTHORIZED, "You must be logged in to access this resource.", {
    ...
    if (!decoded || !decoded.iat || !decoded.id) {
        throw new AppErrorV4(StatusCodes.UNAUTHORIZED, "Invalid or Expired Token, Please login again.", {
