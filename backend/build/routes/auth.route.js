...
import { loginUser, registerUser, logoutUser, refreshAccessToken, changePassword, } from "../controllers/auth.controller.js";
...
]), validationAndFileCleanupHandler(RegisterSchema), registerUser);
router
    .route("/login")
